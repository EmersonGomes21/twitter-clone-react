...
>strong, span{
  ...
  overflow: hidden;
  /* se a tela ficar pequena demais as linhas recebem "..." */
}
...
flex-wrap: wrap; /* para os objetos se adequarem ao container */
margin: 11px auto  0;
...
&:nth-child(1) /* para o primeiro item*/{
&, >svg path { /* estilando o elemento pai e o elemento 1 */
color: var(--gray);
}}
